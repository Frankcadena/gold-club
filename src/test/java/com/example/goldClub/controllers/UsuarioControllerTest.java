...
//esta prueba unitaria asegura que UsuarioController maneje correctamente las operaciones de registro e inicio de sesión, 
//interactuando adecuadamente con los servicios relacionados y devolviendo las respuestas correctas al cliente según el resultado
// de cada operación.
...
public class UsuarioControllerTest {
    ...
    public void testLoginUsuario_Exitoso() {
        Usuario usuario = new Usuario();
        usuario.setEmail("pipe@example.com");
    ...
    public void testLoginUsuario_InvalidCredentials() {
        ...
        assertEquals(401, response.getStatusCodeValue(), "El código de estado HTTP débe ser 401");
