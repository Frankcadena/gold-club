...
//prueba unitaria para asegurar que "JwtService" maneje correctamente la creación, validación y extracción de datos de los tokens
...
public class JwtServiceTest {
    ...
    public void testIsTokenValid() {
        ...
        // Para `isTokenValid`, no se necesita mockear `jwtService` sino que se debe crear un token válido y verificar su validez.
        ...
        // No es necesario mockear `jwtService aquí, ya que se está probando el método real.
    ...
    public void testExtractClaim() {
        ...
        // En este caso de `extractClaim`, simplemente se usa el método real.
